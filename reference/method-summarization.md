# Method Summarization — Certora Prover Documentation 0.0 documentation

# Method Summarization[](#method-summarization "Link to this heading")
...
## How Summarization Helps Solvers[](#how-summarization-helps-solvers "Link to this heading")
...
## Example: Summarization for a complex function[](#example-summarization-for-a-complex-function "Link to this heading")
...
2.  **Choosing Summarization Techniques:**
    ...
    *   Users may experiment with different summarization strategies to find the right balance between precision and efficiency. for more information, see [Summarization](../../cvl/methods.html).
